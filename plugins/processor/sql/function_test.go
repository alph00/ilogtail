...
//		f := &Locate{}
//		// Test normal case
//		result, err := f.Process("l", "hello", "3")
//		if err != nil {
//			t.Errorf("Unexpected error: %v", err)
//		}
//		if result != "3" {
...
//		}
//		// Test when position is greater than string length
//		result, err = f.Process("l", "hello", "10")
//		if err != nil {
//			t.Errorf("Unexpected error: %v", err)
//		}
//		if result != "0" {
...
//		result, err = f.Process("l", "hello", "0")
//		if err != nil {
//			t.Errorf("Unexpected error: %v", err)
//		}
//		if result != "0" {
...
//			t.Errorf("Expected 'NULL', but got '%s'", result)
//		}
//		// Test when position is not a number
//		result, err = f.Process("l", "hello", "abc")
//		if err == nil {
//			t.Errorf("Expected error, but got nil")
//		}
//	}
